...
public class AbsoluteXpathTest {
    public static void main(String[] args) {
        ...
        //click on login without entering usernamename and password
        //to invoke warning message
        driver.findElement(By.className("login-btn")).click();
        BrowserUtils.wait(3);
        WebElement warningMesssage=driver.findElement(By.xpath("/html/body/table/tbody/tr[2]/td/div/div/div[2]"));
        ...
        System.out.println(warningMesssage.getText());
